...
export { TOKENS, MODULES, MODUL_PFADE, modulHref, tokenVars, FONT_HREF, fontLink, suiteUrl, SUITE_DOMAIN, SUITE_LEGACY_DOMAIN, SUITE_ZENTRAL_URL, legacyZiel, zentralZiel, SUITE_BASE_PATH, withBasePath } from './tokens.mjs';
